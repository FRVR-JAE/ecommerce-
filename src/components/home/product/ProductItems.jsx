          ...
          <div className='box' key={items.id}>
            <div className='img'>
              ...
              <div className='overlay'>
                ...
                */}
                <motion.button whileHover={{scale:1.2}} className='button' onClick={() => addToCart(items)}>
                  <FiShoppingBag />
                </motion.button>
                <motion.button whileHover={{scale:1.2}} className='button'>
                  <AiOutlineHeart />
                </motion.button>
                <motion.button whileHover={{scale:1.2}} className='button' onClick={() => onOpenImage(items.imgUrl)}>
                  <FiSearch />
                </motion.button>
              </div>
            </div>
